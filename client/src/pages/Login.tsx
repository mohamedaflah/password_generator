      ...
      <div className="px-8 py-6 bg-white rounded-lg shadow-md text-left w-full md:w-2/3 lg:w-1/2">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between mb-4">
            <button
              className={`cursor-pointer bg-blue-500 hover:bg-blue-700 text-white flex items-center justify-center gap-2 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${
